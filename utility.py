...
def parse_args():
    ...
    add_arg('pretrained_model', str,    'ResNet50_pretrained', "The init model path.")
    add_arg('dataset',          str,   'coco2017',  "coco2014, coco2017.")
    add_arg('class_num',        int,   2,          "Class number.")
    add_arg('data_dir',         str,   'icdar2015',        "The data root path.")
    ...
    #SOLVER
    add_arg('learning_rate',    float,  0.0005,     "Learning rate.")
    ...
    add_arg('im_per_batch',       int,   14,        "Minibatch size.")
    ...
    add_arg('image_path',       str,   'icdar2015/img_116.jpg',  "The image path used to inference and visualize.")
    # ce
    parser.add_argument(
